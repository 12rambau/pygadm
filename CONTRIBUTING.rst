...
Thank you for your help improving **pyGADM**!

**pyGADM** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **pyGADM** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/pygadm
   cd pygadm
...
This will install the **pyGADM** library, together with two additional tools:
